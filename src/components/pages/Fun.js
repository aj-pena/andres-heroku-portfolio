...
const diyProjects = [
  ...
  },
  {
      ...
      image: Cat,
      description: 'Fostering cats during the past three years has helped my wife and I get through difficult times. Winter is a challenging period for us, as we are not used to spending so much time indoors. In 2019, I wanted to have a reason that would get me excited to go out, and I wanted to make our surroundings a little warmer for passers-by. I figured making and putting some ice-cats in random places would be fun and would bring a smile to every other person. Click on "more" to see other cats my wife, friends and I installed.',
  },
  {
      title: 'Laser-Cutted Tree Lamp',
      resource: 'https://drive.google.com/drive/folders/1-WMjtx1KKPwbfnOPpuW7RM22fg4pGpAV?usp=sharing',
      image: TreeLamp,
      description: 'I grew up in a country side house with trees around. I would fall asleep with the shadows and silouhettes of trees around me. When I moved to a high-rise appartment in 2018 I found myself missing those shadows and silohuettes at night. I built this lamp to simulate those shadows while I enjoy a hot-tub in winter with all other lights turned off. I still need to improve the material (Metal?) and find another light source (maybe a candle?) that will project larger and smoother shadows. I enjoyed learning the basics of laser-cutting to build this project. Click on "more" to see photos from other laser-cutting projects.',
  },
  {
